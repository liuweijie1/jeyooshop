    ...
    <div class="layui-body">
        ...
        <div style="padding: 15px;">
            ...
            <div class="layui-col-xs6 layui-col-md12">
                <div class="grid-demo grid-demo-bg2" style="background-color:#52cdec;line-height:50px;padding:0 30px;font-size:18px;color:white;">代理公司</div>
            </div>
                            ...
                            <form class="layui-form" action="">
                                ...
                                <div class="layui-form-item">
                                        <div class="layui-inline" style="width: 190px">
                                                ...
                                                <select name="modules" lay-verify="required" lay-search="" id="companyname">
                                    ...
                                    <div class="layui-inline">
                                        <label class="layui-form-label layui-label1-width" >創建時間 :</label>
                                    ...
                                    <div class="layui-inline">
                                        <label class="layui-form-label layui-label1-width" >修改時間 :</label>
                                        <div class="layui-input-inline layui-inline-width" >
                                            <input type="text" name="startTime" id="updatestartTime"  placeholder="起始日期" autocomplete="off" class="layui-input">
                                        </div>
                                        <div class="layui-input-inline layui-inline-width" >
                                            <input type="text" name="endTime" id="updateendTime"  placeholder="結束日期" autocomplete="off" class="layui-input">
                                        </div>
