					        ...
					        <div class="layui-card-body">
					        	<form class="layui-form" action="">
										    ...
										    <div class="layui-inline">
										      ...
										      <div class="layui-input-inline layui-inline-width" >
										        <input type="text" name="beginEvidenceTime" id="beginEvidenceTime"  placeholder="起始日期" autocomplete="off" class="layui-input">
										      </div>
										      <label class="layui-form-label" style="width:10px;padding:10px 0 10px 0;text-align: left;">-</label>
										      <div class="layui-input-inline layui-inline-width" >
										        <input type="text" name="endEvidenceTime" id="endEvidenceTime"  placeholder="結束日期" autocomplete="off" class="layui-input">
										      </div>
