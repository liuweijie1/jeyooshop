		...
		<div style="padding: 15px;">
			...
			<div class="layui-row">
				...
				<div class="layui-col-xs6 layui-col-md12">
					<div class="grid-demo grid-demo-bg2" style="background-color:#52cdec;line-height:50px;padding:0 30px;font-size:18px;color:white;">放盤詳情</div>
				</div>
			</div>
			<div class="layui-row layui-col-space15">
					...
					<div class="layui-card">
						...
						<div class="layui-card-body">
							<div class="layui-row layui-row1">
								<div class="layui-inline" style="height: 40px;width: 100%;line-height: 40px;">
									<label style="font-weight:bold;padding:9px 15px;">${releaseResult.regionname}</label>
								    <label style="font-weight:bold;padding:9px 15px;">${releaseResult.estatename}</label>
								    <label style="font-weight:bold;padding:9px 15px;">${releaseResult.rentaltype==1?"出租":"出售"}</label>
								    <label style="font-weight:bold;padding:9px 15px;">${releaseResult.titlecn}</label>
								</div>
							</div>
							<div class="layui-row layui-row1">
							...
							<div class="layui-row layui-row1">
								<div class="layui-inline">
									...
									<div class="layui-input-inline">
										<%-- <input type="tel"   autocomplete="off" class="layui-input checkOrder" value="<c:if test='${userOrder.orderstatus=="0"}'>未支付</c:if><c:if test='${userOrder.orderstatus=="1"}'>已支付</c:if>"> --%>
										<label class="layui-form-label layui-label-width" >${empty releaseResult.buildingname?'/':releaseResult.buildingname}</label>
									</div>
								</div>
							</div>
							<div class="layui-row layui-row1">
							...
							<div class="layui-row layui-row1">
								<div class="layui-inline">
									...
									<div class="layui-input-inline">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
										<label class="layui-form-label layui-label-width" ><fmt:formatDate value='${releaseResult.publictime }' pattern='yyyy-MM-dd hh:mm:ss'  /></label>
									</div>
								</div>
							</div>
							<div class="layui-row layui-row1">
								<div class="layui-inline">
									...
									<div class="layui-input-inline">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
										<label class="layui-form-label layui-label-width" ><fmt:formatDate value='${releaseResult.updatetime }' pattern='yyyy-MM-dd hh:mm:ss'  /></label>
									</div>
								</div>
							</div>
							<div class="layui-row layui-row1">
								<div class="layui-inline">
									...
									<div class="layui-input-inline">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
										<label class="layui-form-label layui-label-width" ><fmt:formatDate value='${releaseResult.expiretime }' pattern='yyyy-MM-dd hh:mm:ss'  /></label>
									</div>
								</div>
							</div>
					...
					<div class="layui-carousel" id="imgCarousel">
						 <div carousel-item>
                            <c:forEach items="${releaseResult.proimg}" var="list" varStatus="s">
                                <div>
                                    <img alt="" src="${list}" style="width: 100% ; height: 300px;">
                                </div>
                            </c:forEach>
                        </div>
					</div>
				...
				<div class="layui-col-md12">
					<div class="layui-row">
						<div class="layui-col-xs6 layui-col-md12">
							<div class="grid-demo grid-demo-bg2 " style="background-color:#2F4056;line-height:40px;padding:0 30px;font-size:16px;color:white;">單位特色</div>
						</div>
					</div>
					<div class="layui-card">
						<div class="layui-card-body">
                         ...
                         <c:if  test="${releaseResult.similar!=null}">   
                            <div class="layui-row">
								<div class="layui-block">
									<label class="layui-form-label" style="width: 150px;font-weight: bold;">代理的臨近單位</label>
									<div class="layui-block">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
							...
							<div class="layui-row">
	                            <div class="layui-block">
	                                <label class="layui-form-label" style="width: 150px;">單位備註：</label>
	                                <div class="layui-block">
							...
							<div class="layui-row">
	                            <div class="layui-block">
	                                <label class="layui-form-label" style="width: 150px;">售價：</label>
	                                <div class="layui-block">
	                        ...
	                        <div class="layui-row">
	                            <div class="layui-block">
	                                <label class="layui-form-label" style="width: 150px;">租價：</label>
	                                <div class="layui-block">
	                        ...
	                        <div class="layui-row">
	                            <div class="layui-block">
	                                <label class="layui-form-label" style="width: 150px;">建築面積：</label>
	                                <div class="layui-block">
	                        ...
	                        <div class="layui-row">
	                            <div class="layui-block">
	                                <label class="layui-form-label" style="width: 150px;">實用面積：</label>
	                                <div class="layui-block">
			...
			<c:forEach items="${releaseResult.user}" var="list" varStatus="s">
				<div class="layui-col-md12">
					<div class="layui-row">
						<div class="layui-col-xs6 layui-col-md12">
							<div class="grid-demo grid-demo-bg2 " style="background-color:#2F4056;line-height:40px;padding:0 30px;font-size:16px;color:white;">聯絡方法</div>
						</div>
					</div>
					<div class="layui-card" style="height: 300px;">
						<div class="layui-card-body">
							<div class="layui-col-md2">
								<img alt="" src="${list.imagepath==null?'/static-res/image/touxiang.jpg':list.imagepath}" style="height: 200px;width: 100%;">
							</div>
							<div class="layui-col-md10">
								<div class="layui-row">
									<div class="layui-block">
										...
										<div class="layui-block">
											<label class="layui-form-label layui-label-width" >${list.contactnamecn}</label>
											<label class="layui-form-label layui-label-width" style="font-size: 18px;">${list.contactnameen}</label>
										</div>
									</div>
								</div>
								<div class="layui-row">
								...
								<div class="layui-row">
									<label class="layui-form-label" ><img alt="" src="/static-res/image/timg.jpg" style="width: 70px;height: 70px;"></label>
                                    <label class="layui-form-label" style="height: 70px;line-height: 70px;font-size: 20px;width: 300px;text-align: left;">TEL：<c:if test="${list.isshowtel}">${list.telphone }</c:if><c:if test="${list.isshowtel == false}">/</c:if></label>
                                    <c:if test="${list.approvalstatus=='PassApproval'}">
                                        <label class="layui-form-label" style="height: 70px;color: #5FB878; line-height: 70px;font-size: 20px;width: 300px;text-align: left;">代理人資料已通過審核</label>
                                    </c:if>
								</div>
							...
							<div class="layui-row" >
								<div class="layui-block" style="height: 50px;line-height: 50px;">
									<label class="" style="color: red;font-size: 16px;">溫馨提示：在未睇樓及未簽約前，請勿付款給業主或代理！</label>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="layui-col-md12">
					<div class="layui-card">
						<div class="layui-card-body">
							<div class="layui-row">
								<div class="layui-block">
									<label class="layui-form-label layui-label-width" >放盤審核狀態：</label>
									<div class="layui-block">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
							...
							<div class="layui-row">
								<div class="layui-block">
									<label class="layui-form-label layui-label-width" >放盘审核时间：</label>
									<div class="layui-block">
										<%-- <input type="tel" name="money"  autocomplete="off" class="layui-input checkOrder" value="${userOrder.money }"> --%>
										<label class="layui-form-label layui-label-width" >${empty releaseResult.approvalTime?'/':releaseResult.approvalTime }</label>
									</div>
								</div>
							</div>
						</div>
				...
				<c:if test="${not empty resource && resource == 'releaseApply'}">
					<c:if test="${releaseResult.approvalstatus == '0' }">
						<div class="layui-card">
							<div class="layui-card-body">
										<div class="layui-input-inline">
											<button class="layui-btn"  id="" style="width: 100px;" onclick="applyBtn()">審核</button>
											<!-- <button type="reset" class="layui-btn layui-btn-primary" style="width: 100px;">導出</button> -->
										</div>
							</div>
						</div>
					</c:if>
...
<script src="/static-res/js/propertyManager/propertyManager.js"></script>
<script src="/static-res/js/propertyManager/releaseApply.js"></script>
