					      ...
					      <div class="layui-card">
					        ...
					        <div class="layui-card-body">
					        	<form class="layui-form" action="">
										    ...
										    <div class="layui-inline">
										      <label class="layui-form-label layui-label1-width" >上架時間 :</label>
										      <div class="layui-input-inline layui-inline-width">
										        <input type="text" name="beginTime" id="beginTime"  placeholder="起始日期" autocomplete="off" class="layui-input">
										      </div>
...
<script type="text/html" id="switchTpl">
  	<input type="checkbox" name="upDown" tag="{{d.propertyid}}" value="{{d.upOrDown}}" lay-skin="switch" lay-text="下架|上架" lay-filter="upDown" {{ d.isadminoffline == '0' ? 'checked' : '' }}/>
</script>
