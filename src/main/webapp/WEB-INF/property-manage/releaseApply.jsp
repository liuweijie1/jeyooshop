					        	...
					        	<form class="layui-form" action="">
										    ...
										    <div class="layui-inline">
										      ...
										      <div class="layui-input-inline layui-inline-width">
										        <input type="text" name="beginPublictime" id="beginPublictime"  placeholder="起始日期" autocomplete="off" class="layui-input">
										      </div>
										      <label class="layui-form-label" style="width:10px;padding:10px 0 10px 0;text-align: left;">-</label>
										      <div class="layui-input-inline layui-inline-width">
										        <input type="text" name="endPublictime" id="endPublictime"  placeholder="結束日期" autocomplete="off" class="layui-input">
										      </div>
										    </div>
										    
										    <div class="layui-inline">
										      <label class="layui-form-label layui-label1-width" >審核時間 :</label>
										      <div class="layui-input-inline layui-inline-width" >
										        <input type="text" name="beginApprovalTime" id="beginApprovalTime"  placeholder="起始日期" autocomplete="off" class="layui-input">
										      </div>
										      <label class="layui-form-label" style="width:10px;padding:10px 0 10px 0;text-align: left;">-</label>
										      <div class="layui-input-inline layui-inline-width" >
										        <input type="text" name="endApprovalTime" id="endApprovalTime"  placeholder="結束日期" autocomplete="off" class="layui-input">
										      </div>
