            ...
            <div class="layui-row">
                ...
                <div class="layui-col-xs6 layui-col-md12">
                    <div class="grid-demo grid-demo-bg2"
                         style="background-color:#52cdec;line-height:50px;padding:0 30px;font-size:18px;">留言反饋列表
                    </div>
                </div>
            </div>
                        ...
                        <div class="layui-card-body">
                            <form class="layui-form" id="myform" action="">
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-inline">
                                        <label class="layui-form-label layui-label1-width">留言反饋時間</label>
                                        <div class="layui-input-inline">
...
<% }
%>--%>
<script src="/static-res/js/leavemessage/getPage.js"></script>
